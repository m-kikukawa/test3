...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("PushNotifications.APNCertificate", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("TinySqlStudio.SearchObjectDoc", mendixObject.getType()))
